...
import org.fly.springboot.demo.repository.AuthorRepository;
import org.fly.springboot.demo.repository.BookRepository;
...
public class BookRepositoryTest {
    ...
    public void findByName() {
        ...
        Author author = authorRepository.findByName("Lewis");
        System.out.println(author);
    }

    @Test
    public void findByNameContaining() {
        Assert.assertEquals(2,bookRepository.findByNameContaining("Spring").size());
        Assert.assertEquals(2,authorRepository.findByNameContaining("e").size());
    }
    ...
    public void margeBook() {
        ...
        System.out.println(bookRepository.findByName("Spring in Action"));
        System.out.println(bookRepository.findByName("Spring in Action (4th Edition)"));
    }
    ...
    public void deleteBook() {
        ...
        System.out.println(bookRepository.findByName("Spring Boot in Action"));
        Assert.assertEquals(2,authorRepository.findAll().size());
        System.out.println(authorRepository.findByName("Peter"));
    }
